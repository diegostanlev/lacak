...
def option():
 ...
 \ \        / /         | |          | |                           |_   _| |  __ \    |__   __|                       | |   
  \ \  /\  / /    __ _  | |_    ___  | |__     ___   _ __   ___      | |   | |  | |      | |     _ __    __ _    ___  | | __
   \ \/  \/ /    / _` | | __|  / __| | '_ \   / _ \ | '__| / __|     | |   | |  | |      | |    | '__|  / _` |  / __| | |/ /
    \  /\  /    | (_| | | |_  | (__  | | | | |  __/ | |    \__ \    _| |_  | |__| |      | |    | |    | (_| | | (__  |   < 
     \/  \/      \__,_|  \__|  \___| |_| |_|  \___| |_|    |___/   |_____| |_____/       |_|    |_|     \__,_|  \___| |_|\_\
                                                                                                                            
                                                                                                                            

              {Wh}[ + ]  C O D E   B Y  Watchers ID Revan  [ + ]
    """)
...
def run_banner():
    ...
    stderr.writelines(f"""{Wh}
         .-.
       .'   `.          {Wh}--------------------------------
       :g g   :         {Wh}| {Gr}Watchers ID - TRACKER - IP ADDRESS {Wh}|
       : o    `.        {Wh}|       {Gr}@CODE BY Watchers ID Revan  {Wh}|
      :         ``.     {Wh}--------------------------------
     :             `.
    :  :         .   `.
    :   :          ` . `.
